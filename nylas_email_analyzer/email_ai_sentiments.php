...
echo "<div style='color:white;background:green;padding:10px;'>Email Text Sentiments Successfully Analyzed. See Below</div>";
...
echo 
  "<div style='background:#c1c1c1;color:black;'><b style='color:#800000'>Email Text Sentimental Analysis</b>
 ...
 <div class='title_css1'><b style='color:#800000;font-size:16px;'>Analyzed Email Sentimental Tags: &nbsp;
</b> $sentiments&nbsp;&nbsp;&nbsp;
...
<br><br><h3 style='width:100%;min-width:100%;'>Email Message Statistical Text Analytics</h3>
...
var overall = '<?php echo $overall ?>';
                ...
                $.post('ai_email_sentiments_statictics.php?negativity='+negativity + "&positivity=" + positivity + "&overall=" + overall,
                function (data)
                {
                    console.log(data);
                     var name = [];
                    ...
                    var chartdata = {
                        ...
                        datasets: [
                            {
                                label: 'Email Text Sentimental Text Analysis',
